...
public class RNNotificationsModule extends ReactContextBaseJavaModule implements AppLifecycleFacade.AppVisibilityListener, Application.ActivityLifecycleCallbacks {
    ...
    @ReactMethod
    public void postSchedulerLocalNotification(ReadableMap notificationPropsMap, int notificationId) {
        ...
        pushNotification.onProjectSchedulerRequest(notificationId);
    }
